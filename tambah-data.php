...
if(isset($_POST["save"])){
    ...
    $query = mysqli_query($connn, "INSERT INTO clients(name, email, phone, address) VALUES ('$name', '$email', '$phone', '$address')");
    echo"
            <script>
  ...
  <body>
    ...
    <div class="container">
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
            <a class="nav-link active" href="tambah-data.php">Tambah Data</a>
            </li>
            <li class="nav-item">
